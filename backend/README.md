...
эвристики по тегам. Для однозначных названий локальные правила имеют приоритет
над AI и устаревшей категорией каталога; сумма позиции в API рассчитывается как
`quantity × price`.
