...
- Вкладка «Чеки» получила новый редакционный дизайн с QR-карточкой, списком
  покупок от новых к старым, компактным предпросмотром чека и тремя самыми
  дорогими категориями. QR-распознавание снова доступно из нижнего листа через
  камеру или медиатеку; отдельный экран сканирования удалён.
