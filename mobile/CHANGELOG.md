...
- Исправлена прокрутка редактируемой анкеты в разделе «Аккаунт»: после ввода и
  закрытия клавиатуры снова доступны поля и действия ниже «Цели питания».

- Внутренние разделы профиля больше не занимают верх экрана полноразмерным
  header: для возврата к профилю остаётся только компактная кнопка-стрелка.
