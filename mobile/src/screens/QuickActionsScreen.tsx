    ...
    >
      ...
      >
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          <View>
            <Text style={[styles.title, { color: theme.text }]}>Быстрые</Text>
            <Text style={[styles.title, { color: theme.text }]}>Действия</Text>

            <Text
              style={[styles.subtitle, { color: theme.muted, width: "auto" }]}
            >
              Что хотите сделать?
            </Text>
          </View>
...
function BigCard(props: QuickActionCardProps) {
  const { theme } = useTheme();
  ...
  return (
    ...
    >
      ...
      >
        <MaterialIcons name={props.icon} size={34} color={props.color} />
      </View>
      ...
      <MaterialIcons name="chevron-right" size={28} color={theme.muted} />
    </Pressable>
  );
}

function SmallCard(props: QuickActionCardProps) {
  const { theme } = useTheme();
  ...
  return (
    ...
    >
      ...
      >
        <MaterialIcons name={props.icon} size={26} color={props.color} />
      </View>
