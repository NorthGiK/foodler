...
export const API_BASE =
  process.env.EXPO_PUBLIC_API_BASE_URL ?? "https://foodler.site/api/api";
export const API_GET_RECEIPT_BY_QR = `${API_BASE}/receipts/get_receipt_by_qr`;
export const API_GET_RECEIPT_BY_RAW_QR = `${API_BASE}/receipts/get_receipt_by_raw_qr`;
