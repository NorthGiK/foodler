...
export default function ScanQrButton({
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        styles.uploadCard,
        { borderColor: theme.primary, backgroundColor: theme.primary, opacity: pressed ? 0.75 : 1 },
      ]}
    >
      <View>
        {themeName === "light"
      ...
      <View style={styles.uploadCopy}>
        <Text
          numberOfLines={1}
          style={[styles.uploadTitle, {color: theme.bg}]}
        >
          Загрузить QR
        </Text>
        <Text
          numberOfLines={2}
          style={[styles.uploadSubtitle, { color: "#fafafa" }]}
        >
