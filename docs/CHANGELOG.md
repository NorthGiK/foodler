...
- Категоризация больше не использует fuzzy, regex или tag-эвристики: после
  строгого GTIN/alias/name lookup авторизованный неизвестный товар передаётся
  в `AI_STRONG_MODEL`, а fuzzy сохранён только для поиска каталога.
